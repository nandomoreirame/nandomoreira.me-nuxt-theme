    ...
    <div class="container">
      <div class="grid grid--1of2">
        <div class="project__content grid__column">
          <h2 class="project__title"><a :href="project.url" :target="`${project.url !== '#' ? '_blank' : '_self'}`">{{ project.name }}</a></h2>
        ...
        <figure class="project__thumbnail grid__column">
          <a class="project__thumbnail-browser" :href="project.url" :target="`${project.url !== '#' ? '_blank' : '_self'}`">
